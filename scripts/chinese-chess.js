...
function createNewGame() {
  ...
  <img class="invisible-img" src="images/chinese-chess/unfold.png">
  `
  ...
  for (let i = 0; i < 4; i ++) {
    for (let j = 0; j < 8; j++) {
      ...
      document.getElementById(`js-piece-img${i}${j}`).src = "images/chinese-chess/unfold.png";
    }
  }
}
...
function changeImage(i, j) {
  if (checkerBoard[i][j]) {
    document.getElementById(`js-piece-img${i}${j}`).src = `images/chinese-chess/${checkerBoard[i][j]}.png`;
  } else {
...
function manageDiePiece(i, j) {
  if (checkerBoard[i][j].includes('r')) {
    ...
    if (redPiece >= 8) {
      document.querySelector('.js-left-die-piece1').innerHTML += `
      <img class="die-piece-img" src="images/chinese-chess/${checkerBoard[i][j]}.png">
      `
    } else {
      document.querySelector('.js-left-die-piece2').innerHTML += `
      <img class="die-piece-img" src="images/chinese-chess/${checkerBoard[i][j]}.png">
